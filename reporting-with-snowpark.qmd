...
Now you can just add python code chunks to your document. I will be using `plotnine` to create plots in our report. 
...
For this report I have changed the plotting library to Plotly for interactive plots.
